...
//eezstreet add
static void CG_IRC_Say_f( void )
{
	IRC_Say(CG_Argv(1));
}

static void CG_IRC_Quit_f( void )
{
	IRC_Quit(CG_Argv(1));
}

static void CG_IRC_Join_f( void )
{
	IRC_Join(CG_Argv(1));
}

static void CG_IRC_Leave_f( void )
{
	IRC_Leave(CG_Argv(1));
}

static void CG_IRC_Me_f( void )
{
	IRC_Say(va("\001ACTION %s\001", CG_Argv(1)));
}

static void CG_IRC_Connect_f( void )
{
	if(IRCRunning == qfalse)
		IRC_Initiate();
	else
		Com_Printf("^3Already connected.\n");
}

static void CG_IRC_Stats_f( void )
{
	IRC_Stats(CG_Argv(1));
}

static void CG_IRC_List_f( void )
{
	IRC_List(CG_Argv(1));
}

static void CG_IRC_Nick_f( void )
{
	IRC_Nick(CG_Argv(1));
}
...
static consoleCommand_t	commands[] = {
	...
	//IRC Commands
	{ "ircsay", CG_IRC_Say_f },
	{ "ircquit", CG_IRC_Quit_f },
	{ "ircjoin", CG_IRC_Join_f },
	{ "ircleave", CG_IRC_Leave_f },
	{ "ircconnect", CG_IRC_Connect_f },
	{ "me", CG_IRC_Me_f },
	{ "ircstats", CG_IRC_Stats_f },
	{ "irclist", CG_IRC_List_f },
	{ "ircname", CG_IRC_Nick_f },
};
